...
export default function Home() {
  ...
  return (
    <main style={{ background: "#111", color: "#fff", minHeight: "100vh", padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <button onClick={handleSubscribe} style={{ background: subscribed ? "#444" : "#ff0000", color: "#fff", border: "none", padding: "14px 28px", fontSize: "20px", borderRadius: "10px", cursor: "pointer" }}>
